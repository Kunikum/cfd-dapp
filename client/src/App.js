        ...
        <div className='App'>
          <div className="navbar pure-menu pure-menu-horizontal">
            <ul className="pure-menu-list">
              <li className="pure-menu-item"><Link to='/' className="pure-menu-link">CFD Dashboard</Link></li>
              <li className="pure-menu-item"><Link to='/price-oracle' className="pure-menu-link">Price Oracle</Link></li>
            </ul>
          </div>
